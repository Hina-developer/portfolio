    ...
    >
      <div className="w-full lgl:w-1/2">
        ...
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Knowledge of Web APIs</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
      ...
      <div className="w-full lgl:w-1/2">
        ...
        <div className="flex flex-col gap-6">
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Python (Django)</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">JavaScript (Node.js)</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Web Frameworks</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Relational Databases (SQL)</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">NoSQL Databases</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
  <p className="text-sm uppercase font-medium">Linux Server Management</p>
  <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
    <motion.span
      initial={{ x: "-100%", opacity: 0 }}
      animate={{ x: 0, opacity: 1 }}
...
<div className="overflow-x-hidden">
  <p className="text-sm uppercase font-medium">Apache2 Configuration</p>
  <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
    <motion.span
      initial={{ x: "-100%", opacity: 0 }}
      animate={{ x: 0, opacity: 1 }}
